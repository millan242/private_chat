...
const ANIMALS = ["wolf", "bear", "hawk", "tiger", "shark", "elephant", "giraffe"]
          ...
          <div className="space-y-5">
            <div className="space-y-2">
              ...
              <div className="flex items-center gap-3">
                <div className="flex-1 bg-zinc-950 border border-zinc-800 p-3 text-zinc-400 text-sm font-mono min-w-0">
                  {username}
                </div>
              </div>
            </div>

            <button className="w-full p-3 bg-zinc-200 text-black text-sm hover:bg-zinc-50 hover:text-black font-bold transition-colors mt-2 cursor-pointer disabled:opacity-50">CREATE SECURE ROOM</button>
          </div>
        </div>
      </div>
    </main>
